<x-app-layout>
    ...
    <body>
                   ...
                   <!--リンク-->
                    <div>
                        @if (array_key_exists('id', $book))
                            <a href="/recommendations/answer/{{ $book['id'] }}/{{ $recruite->id }}" class="text-indigo-500 hover:text-indigo-600 active:text-indigo-700 font-semibold transition duration-100">感想を書く</a>
                        @else
                            <p>この本の感想は書けません</p>
                        @endif
                    </div>
        ...
        <div class="footer">
            <a href="/recommendations/answer/{{ $recruite->id }}">検索しなおす</a>
        </div>
    </body>
</x-app-layout>